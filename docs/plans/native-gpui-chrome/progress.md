...
| 8.x — Behavioral fidelity pass (Strand B — missing surfaces) | ⏳ in progress (1 of 8 crates) | `13421226` (8.17) | (folded into 249) | New crates shipped: `folder_tree`.  Pending: `frontmatter_panel` (8.15), `raw_editor` (8.16), `filter_builder` (8.18), `workspace_switcher` (8.19), `note_retargeting` (8.20), `rendering_primitives` (8.21), `onboarding_prompts` (8.22).  Each follows the `from_or_empty` + `from_mock` pattern set by `folder_tree`. |
