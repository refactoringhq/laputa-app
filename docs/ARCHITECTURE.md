...
| `convert_pdf_to_markdown_note` | Validate a PDF inside the active vault, extract embedded text with optional OCR, create a sibling Markdown note linked to the source PDF |
