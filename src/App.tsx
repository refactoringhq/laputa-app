...
function App() {
  ...
  const isIcloudVault = activeVaultProvider === 'icloud-drive'
  const isIcloudOnlyVault = false // iCloud and Git can coexist -- never hide Git UI based on provider alone
