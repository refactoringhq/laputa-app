...
function renderFindBar(
    overrides: Partial<React.ComponentProps<typeof RawEditorFindBar>> = {},
) {
    const view = {
        dispatch: vi.fn(),
        focus: vi.fn(),
...
describe("RawEditorFindBar", () => {
    ...
    it("reports a no-match status when the query has no occurrences", async () => {
        renderFindBar({ doc: "Alpha beta" });
